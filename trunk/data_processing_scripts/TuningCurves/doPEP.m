function [cellHandles,sOut] = doPEP(sEvents,varargin)
	...
	vecWindow = [max(vecWindow(1),-(min(vecOn)-1)) min((length(vecTrace)-max(vecOn)-1),vecWindow(end))];
